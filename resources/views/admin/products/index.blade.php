<x-admin-layout>
        ...
        <div class="flex items-center gap-2">
            ...
            <form action="{{ route('admin.products.index') }}" method="GET"
                ...
                <a href="{{ route('admin.products.index') }}"
                    class="text-xs text-neutral-400 hover:text-black transition">
                    Clear
                </a>
                @endif
            </form>
    ...
    <div class="mb-6 text-sm text-neutral-500">
        ...
        <span class="text-neutral-400 ml-2">({{ $products->total() }} found)</span>
    </div>
    @endif
    ...
    <div class="bg-white min-h-[500px]">
        ...
        <div class="flex flex-col items-center justify-center h-64 text-neutral-400">
            <p class="text-sm font-light mb-4">
                @if(!empty($search))
                No products matching "{{ Str::limit($search, 30) }}" were found.
                @else
