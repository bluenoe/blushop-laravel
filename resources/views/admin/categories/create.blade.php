...
<form method="POST" action="{{ route('admin.categories.store') }}" class="max-w-xl space-y-4">
    ...
    <div>
        ...
        <div class="flex items-center gap-2">
            <input type="text" name="slug" value="{{ old('slug') }}" x-ref="slug" readonly class="flex-1 px-3 py-2 rounded-md bg-[#0d1426] border border-gray-700 text-gray-100">
    ...
    <div>
        ...
        <textarea name="description" rows="4" class="w-full px-3 py-2 rounded-md bg-[#0d1426] border border-gray-700 text-gray-100">{{ old('description') }}</textarea>
    </div>
