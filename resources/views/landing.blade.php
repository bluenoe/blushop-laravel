...
<x-app-layout>
    {{-- Hero Section --}}
    <section class="bg-gradient-to-br from-indigo-600 via-indigo-500 to-indigo-400 text-white">
        <div class="max-w-7xl mx-auto px-6 py-20 sm:py-24">
            <div class="text-center transition-opacity duration-700 ease-out">
                <h1 class="text-4xl sm:text-5xl font-extrabold tracking-tight">Welcome to BluShop</h1>
                <p class="mt-4 text-lg sm:text-xl opacity-90">Minimal, student-friendly e-commerce. Great quality, fair prices.</p>
                <div class="mt-8">
    ...
    <section class="max-w-7xl mx-auto px-6 py-12 sm:py-16">
        ...
        <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            @foreach($highlights as $h)
                <div class="rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 shadow-sm hover:shadow-lg transition duration-300 hover:scale-[1.02]">
    ...
    <section class="max-w-7xl mx-auto px-6 py-12 sm:py-16">
        <div class="flex items-end justify-between">
            ...
            <a href="{{ route('products.index') }}" class="text-indigo-600 dark:text-indigo-400 font-medium hover:underline">View all</a>
        </div>
