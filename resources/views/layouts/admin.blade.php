...
<head>
    ...
    <style>
        ...
        /* Tùy chỉnh thanh cuộn cho giống Mac/iOS */
...
<body class="font-sans antialiased bg-white text-neutral-900 selection:bg-black selection:text-white"
    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        ========================================== --}}
        <aside
            class="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-neutral-100 transform transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:h-screen"
            :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'">

            {{-- Logo --}}
            <div class="h-20 flex items-center px-8 border-b border-neutral-100">
            ...
            <nav class="p-6 space-y-1">
                <div class="text-[10px] uppercase tracking-[0.2em] text-neutral-400 font-bold mb-4 px-2">Overview</div>

                <a href="{{ route('admin.dashboard') }}"
                    class="flex items-center gap-3 px-2 py-3 text-sm font-medium rounded-md group transition-colors {{ request()->routeIs('admin.dashboard') ? 'bg-black text-white' : 'text-neutral-600 hover:bg-neutral-50 hover:text-black' }}">
   ...
   {{ request()->routeIs('admin.users.*') ? 'bg-black text-white' : 'text-neutral-600 hover:bg-neutral-50 hover:text-black' }}">
            ...
            {{-- User --}}
            <div class="absolute bottom-0 left-0 right-0 p-6 border-t border-neutral-100 bg-white">
   ...
   {{ request()->routeIs('admin.categories.*') ? 'bg-black text-white' : 'text-neutral-600 hover:bg-neutral-50 hover:text-black' }}">
        ...
        MAIN CONTENT
        ========================================== --}}
        <main class="flex-1 min-h-screen bg-white md:bg-neutral-50/50 relative overflow-y-auto">
